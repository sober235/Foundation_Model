...
- **当前状态:v2.5 路线已合入 main(`779123f`,2026-09-22),读片人已确认可找到,下一步是 PR-A Gate 0(fastMRI+ 框上下翻转修复)。先读 `STATUS.md`,再读 v2.5 计划 §2、§4、§7–§12、§19、§23。别再在 SKM-TEA 膝关节上找"退化让绑定失效"(G2 裁决已测死),也别把 SynthSeg 查表当脑侧真值。**每个函数先写测试;结构性测试是"loss 在降但标签错了"的唯一自动防线。
